...
> This is the canonical instruction file for all coding and content agents.
> Update this file when shared repository guidance changes. `CLAUDE.md`
> imports it for Claude Code; Codex reads `AGENTS.md` directly. Do not
> duplicate shared instructions in agent-specific files.
